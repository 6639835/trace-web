...
export default function SupportPage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Common Issues */}
      <PageSection>
        <SectionHeading title="Common issues" />
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-5 md:gap-6">
          ...
          >
            <BulletList className="mt-3">
              ...
              <BulletItem>Enable full trust in Settings &gt; Certificate Trust Settings</BulletItem>
      ...
      {/* Documentation Links */}
      <PageSection>
        <SectionHeading title="Popular documentation" />
