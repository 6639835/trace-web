...
export default function FeaturesPage() {
  return (
    <div className="flex flex-col">
      ...
      <PageSection>
        <SectionHeading title="Traffic modification and manipulation" />
        ...
        <div className="grid gap-6 sm:grid-cols-2 sm:gap-7 md:gap-8">
          <div>
            ...
            <p className="mb-4 leading-relaxed text-muted-foreground">
              Designed to minimize battery and performance impact during capture sessions. Efficient
              packet processing and memory management allow for extended debugging sessions.
            </p>
            <BulletList>
      ...
      <PageSection width="readable" innerClassName="text-center">
        <SectionHeading
          ...
          description="Leverages Apple's latest frameworks and APIs for reliability and performance."
