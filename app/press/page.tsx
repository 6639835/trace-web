...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://trace.justinl.site/press',
  },
};
    ...
    <div className="flex flex-col">
      ...
      <section className="container py-section">
        <div className="mx-auto max-w-readable text-center">
          <Newspaper className="mx-auto mb-4 h-10 w-10 text-muted-foreground sm:mb-6 sm:h-12 sm:w-12" />
          <h1 className="mb-3 text-3xl font-bold tracking-tight sm:mb-4 sm:text-4xl md:text-5xl">
            Press Kit
          </h1>
          <p className="text-sm leading-relaxed text-muted-foreground sm:text-base lg:text-lg">
            Brand assets, logos, and media resources for writing about Trace.
          </p>
        </div>
      </section>
