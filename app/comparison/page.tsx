...
export default function ComparisonPage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Comparison Table */}
      <PageSection>
        <SectionHeading title="Feature comparison" titleClassName="md:mb-10" />
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="text-center text-sm text-muted-foreground">Varies</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </div>
      ...
      {/* Feature Deep-Dives */}
      <PageSection>
        <SectionHeading title="Key differences" titleClassName="md:mb-10" />
        <div className="grid gap-6 sm:gap-7 md:gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <CardDescription className="leading-relaxed">
                <strong className="text-foreground">Trace:</strong> Fully open source (MIT license).
                Audit the code, verify security claims, contribute features, or fork for custom
                needs.
              </CardDescription>
              <CardDescription className="leading-relaxed">
                <strong className="text-foreground">Charles/Proxyman:</strong> Proprietary software
                with commercial support, regular updates, and mature feature sets built over many
                years.
              </CardDescription>
              <CardDescription className="leading-relaxed">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <CardDescription className="leading-relaxed">
                <strong className="text-foreground">Trace:</strong> Newer tool (launched 2024) with
                core features stable but still building advanced capabilities. Active development
              ...
              <CardDescription className="leading-relaxed">
                ...
                with polished UI and active development. Good balance of maturity and modern design.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
      ...
      {/* When to use each */}
      <PageSection width="readable">
        <SectionHeading title="When to use each tool" titleClassName="mb-6 sm:mb-8 sm:text-3xl" />
      ...
      {/* Fair closing */}
      <PageSection width="readable" innerClassName="text-center">
        <SectionHeading
          title="The right tool for the job"
          titleClassName="mb-3 sm:mb-4 sm:text-3xl"
          description="All three tools are excellent choices for network debugging. Your best option depends on your workflow, platform requirements, and priorities. Many developers use multiple tools for different scenarios."
          descriptionClassName="mb-6 sm:mb-8"
          align="center"
        />
