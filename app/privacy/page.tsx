    ...
    <div className="flex flex-col">
      ...
      <section className="container py-section">
        <div className="mx-auto max-w-readable">
          ...
          <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Privacy Policy</h1>
          <p className="mb-6 text-sm leading-relaxed text-muted-foreground sm:text-base">
            How Trace handles your data with complete transparency and privacy-first principles.
          </p>
          <dl className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm sm:grid-cols-4">
            {[
              { term: 'Effective', value: 'January 14, 2026' },
              { term: 'App', value: 'Trace' },
              { term: 'Developer', value: 'Justin' },
              { term: 'Contact', value: 'epa6643@gmail.com' },
            ].map(({ term, value }) => (
              <div key={term}>
                <dt className="font-semibold">{term}</dt>
                <dd className="text-muted-foreground">
                  {term === 'Contact' ? (
                    <a href="mailto:epa6643@gmail.com" className="hover:underline">
                      {value}
                    </a>
                  ) : (
                    value
        ...
        <div className="container py-6 sm:py-8">
          <div className="mx-auto max-w-readable">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="mb-1 font-semibold">The short version</p>
                <ul className="space-y-1 text-sm leading-relaxed text-muted-foreground">
                  <li>We do not collect, transmit, sell, or share your personal data.</li>
                  <li>All network traffic data is stored on your device only.</li>
                  <li>Data leaves your device only if you explicitly export it.</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                ...
                <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  ...
                  configured by the App&apos;s Network Extension (proxy-only mode). Depending on
                  your device and usage, Capture Data may include highly sensitive information, such
                  as:
                </p>
                ...
                <div className="mt-4 rounded-lg border bg-background p-4">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    Capture Data is created by your network activity and by apps/services you use.
                    The App does not create this data; it enables you to view and manage it for
                    debugging.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  The App supports on-device TLS interception (&quot;TLS MITM&quot;) for debugging.
                  To do this, the App may generate a local root Certificate Authority (CA) and
                  require you to install and trust it.
                </p>
                <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
      ...
      {[
        ...
        },
        {
          ...
          content: (
            <>
              <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
                All data is stored on your device and retained until you delete it, which you can do
                by:
              </p>
              <ul className="ml-4 list-inside list-disc space-y-2 text-sm leading-relaxed text-muted-foreground sm:text-base">
        ...
        },
        {
          ...
          content: (
            <>
              <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
                We use reasonable safeguards consistent with an on-device iOS app, including relying
                on iOS security features such as app sandboxing and device encryption. However, no
                method of storage is 100% secure.
              </p>
              <p className="mb-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
        ...
        {
          num: '10',
          title: 'Legal Compliance and Authorized Use',
          content: (
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              The App is intended for debugging and inspection of traffic that you are authorized to
              access and analyze. You agree not to use the App to intercept or monitor
              communications without proper authorization. You are solely responsible for compliance
              with applicable laws, regulations, and third-party terms.
            </p>
          ),
        },
        {
          ...
          content: (
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              from children. Because the App does not transmit data to us, we have no practical
              means to identify users&apos; ages.
            </p>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              update the Effective Date above and publish the revised policy where it is made
              available (e.g., in the App listing or repository page).
            </p>
          ),
        },
      ].map(({ num, title, content }, i) => (
        <PageSection key={num} className={i % 2 === 0 ? '' : 'border-y bg-muted/30'}>
          <div className="mx-auto max-w-readable">
            <h2 className="mb-6 text-xl font-bold tracking-tight sm:mb-8 sm:text-2xl">
              {num}. {title}
            </h2>
