...
export default function ShowcasePage() {
  return (
    <div className="flex flex-col">
      ...
      <PageSection>
        <SectionHeading title="Configuration examples" />
  ...
  "filters": [
    ...
    },
    {
      ...
      {/* Community Showcase */}
      <PageSection innerClassName="text-center">
        ...
        <SectionHeading
          ...
          description="Found a creative way to use Trace? Share it with the community in GitHub Discussions."
